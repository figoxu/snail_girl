...
var Assets = assets.NewFileSystem(map[string][]string{"/": []string{"assets"}, "/assets": []string{"domain_vaild.tpl", "domain_service_impl_test.tpl", "domain_repo.tpl", "domain_data.tpl", "domain_repo_impl_test.tpl", "domain_repo_impl.tpl", "domain_repo_internal_model.tpl", "domain_service.tpl", "domain_service_impl.tpl"}}, map[string]*assets.File{
	"/assets/domain_service_impl_test.tpl": &assets.File{
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1626924880, 1626924880054603371),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1626933088, 1626933088865986581),
		...
		Path:     "/assets",
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1626933088, 1626933088866096244),
		Data:     nil,
	}, "/assets/domain_vaild.tpl": &assets.File{
		Path:     "/assets/domain_vaild.tpl",
		FileMode: 0x1a4,
		Mtime:    time.Unix(1626924100, 1626924100825547452),
		Data:     []byte(_Assets4d811f06d8254c6b793a418b9112473b48fcff1d),
