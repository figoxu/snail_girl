...
var Assets = assets.NewFileSystem(map[string][]string{"/": []string{"assets"}, "/assets": []string{"domain_service_impl_test.tpl", "domain_repo.tpl", "domain_data.tpl", "domain_repo_impl_test.tpl", "domain_repo_impl.tpl", "domain_repo_internal_model.tpl", "domain_service.tpl", "domain_service_impl.tpl"}}, map[string]*assets.File{
	"/": &assets.File{
		Path:     "/",
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1626860051, 1626860051770146241),
		Data:     nil,
	}, "/assets/domain_data.tpl": &assets.File{
		Path:     "/assets/domain_data.tpl",
		FileMode: 0x1a4,
		Mtime:    time.Unix(1626859602, 1626859602217536355),
		...
		Path:     "/assets",
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1626862292, 1626862292536682119),
		Data:     nil,
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1626862177, 1626862177241030486),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1626859602, 1626859602218469684),
		...
		FileMode: 0x1a4,
		Mtime:    time.Unix(1626862292, 1626862292536579310),
